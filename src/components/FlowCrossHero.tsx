...
const FlowCrossHero = () => {
  ...
  const stats = [
    { icon: Zap, value: "+40%", label: "Faster Loading" },
    { icon: Shield, value: "+60%", label: "Memory Efficiency" },
    { icon: Users, value: "490", label: "Average FPS" },
    { icon: Star, value: "+35%", label: "Optimization" },
  ];
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
          ...
          <h1 className="text-5xl md:text-7xl font-bold leading-tight">
            <span className="hero-title neon-text bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent animate-gradient-x">
              Flowcross
            </span>
          </h1>
