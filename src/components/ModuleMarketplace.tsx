...
import { Search, Download, Star, Filter, Grid, List, Palette, Zap, Shield, Gamepad2, Upload } from "lucide-react";
...
const ModuleMarketplace = () => {
  ...
  return (
    <section className="py-20 px-4 relative">
        ...
        <div className="text-center mt-16">
          <div className="glass-effect p-8 rounded-2xl max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="premium" size="lg" onClick={() => setIsUploadOpen(true)}>
      ...
      <ModuleUploadForm isOpen={isUploadOpen} onClose={() => setIsUploadOpen(false)} />
    </section>
  );
};
